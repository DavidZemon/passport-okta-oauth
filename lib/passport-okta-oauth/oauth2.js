...
class Strategy extends OAuth2Strategy {
   ...
   * @param {string | undefined} options.authServerID authServerID is the authorization server ID. If it is defined, the token URL might be something like `https://example.okta.com/oauth2/authServerID/v1/token`
